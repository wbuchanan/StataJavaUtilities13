...
public class DataSetFactory {
	 ...
	 * string will return the object used for JSON serialization
	 */
	public static StataData dataSetFactory(String type, Meta metaob, Object
		missingValue) {
		...
		switch (type) {
			...
			case "byte":
				...
				// Return a Byte Array class data Set
				return new DataSetByteArrays(metaob, (byte) missingValue);

			// If type argument is 'int'
			case "int":

				// Return an Integer Array class data Set
				return new DataSetIntArrays(metaob, (int) missingValue);

			// If type argument is 'long'
			case "long":

				// Return a Long Array class data Set
				return new DataSetLongArrays(metaob, (long) missingValue);

			// If type argument is 'double'
			case "double":

				// Return a Double Array class data Set
				return new DataSetDoubleArrays(metaob, (double) missingValue);
