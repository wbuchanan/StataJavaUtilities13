...
public class RecordFactory {
	 ...
	 */
	public static Record recordFactory(String type, Integer obid, Meta metaob) {
	 ...
	 * string will return the object used for JSON serialization
	 */
	public static Record recordFactory(String type, Integer obid, Meta
		metaob, Object missingValue) {
		...
		switch (type) {
			...
			case "byte":
				...
				// Return a Byte Array class data record
				return new DataRecordByteArray(obid, metaob, (byte) missingValue);

			// If type argument is 'int'
			case "int":

				// Return an Integer Array class data record
				return new DataRecordIntArray(obid, metaob, (int) missingValue);

			// If type argument is 'long'
			case "long":

				// Return a Long Array class data record
				return new DataRecordLongArray(obid, metaob, (long) missingValue);

			// If type argument is 'double'
			case "double":

				// Return a Double Array class data record
				return new DataRecordDoubleArray(obid, metaob, (double) missingValue);
